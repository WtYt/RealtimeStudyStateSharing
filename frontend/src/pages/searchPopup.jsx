...
async function stubSearchByName() { await sleep(200); return []; }
async function stubSearchByCategory() { await sleep(200); return []; }
                        ...
                        <>
                            <Stack direction="row" spacing={1}>
                                <TextField
                                    ...
                                    autoFocus
                                />
                                <Button variant="contained" onClick={handleSearchByName} disabled={!String(inputName).trim()}>
                                    検索
                                </Button>
                            </Stack>

                            <Divider sx={{ my: 2 }} />
                            <ResultsList loading={loading} error={error} results={results} onRoomClick={handleRoomClick} />
                        </>
                    )}
                    ...
                    {tab === 'category' && (
                        <>
                            ...
                            <Stack direction="row" spacing={1} justifyContent="flex-end" sx={{ mt: 1.5 }}>
                                <Button onClick={() => { setSelectedKey(''); setResults([]); setError(''); }}>
                                    リセット
                                </Button>
                                <Button variant="contained" onClick={handleSearchByCategory} disabled={!selectedKey}>
                                    検索
                                </Button>
                            </Stack>
