...
export default function DeskNoteCard({
  name,
  status,
  comment,
  colorSeed = 0,
  ...
  const statusMeta = (v) => {
    switch (v) {
      case 2:
        return { label: '取り組み中', color: '#2e7d32' };
      case 1:
        return { label: '離席中', color: '#ed6c02' };
      default:
        return { label: 'オフライン', color: '#757575' };
    }
  };
